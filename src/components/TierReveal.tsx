    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl p-8 mx-4 max-w-sm text-center relative overflow-hidden"
        >
          ...
          <motion.div
            className="absolute inset-0 bg-gradient-to-r from-purple-100 to-blue-100 rounded-3xl"
            animate={{ 
              opacity: [0.3, 0.6, 0.3],
              scale: [1, 1.02, 1]
            }}
          ...
          <AnimatePresence>
            {showContinueButton && (
              <motion.button
                ...
                onClick={onComplete}
                className="px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-200 transform hover:scale-105 relative z-10"
              >
                <motion.div
                  animate={{ 
                    boxShadow: [
